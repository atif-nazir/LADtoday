// ============================================================
// Agent 37 - Community Agent
// Phase: DISTRIBUTE | Model: gemini-2.5-flash | Depends on: rewrite,cross-platform
// ============================================================
// Generates engagement prompts and reply templates
// ============================================================
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (runId) {
      for (const dep of ["rewrite","cross-platform"]) {
    ...
    const prompt = `You are a specialized AI agent (Community Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Generate community engagement content: 3 discussion starter questions, 5 reply templates (praise/criticism/question/off-topic/troll), poll idea with 4 options, user-generated content prompt, and a controversial but safe debate angle.`;
