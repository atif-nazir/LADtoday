// ============================================================
// Agent 47 - Guardian Agent
// Phase: OPERATE | Model: gemini-2.5-flash | Depends on: rewrite,publish
// ============================================================
// Final audit pass with APPROVED/REVIEW/REJECTED verdict
// ============================================================
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const prompt = `You are a specialized AI agent (Guardian Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Perform final editorial audit. Check: factual claims have sources, no plagiarism indicators, brand voice consistency, legal risk (defamation/copyright), cultural sensitivity for Pakistan (religious/political), advertiser safety. Issue verdict: APPROVED, REVIEW (with reasons), or REJECTED (with blockers).`;
