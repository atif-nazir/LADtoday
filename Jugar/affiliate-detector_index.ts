// ============================================================
// Agent 42 - Affiliate Detector Agent
// Phase: MONETIZE | Model: gemini-2.5-flash | Depends on: rewrite,seo
// ============================================================
// Identifies affiliate marketing opportunities in content
// ============================================================
...
const AGENT_KEY = "affiliate-detector";
const AGENT_NAME = "Affiliate Detector Agent";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const prompt = `You are a specialized AI agent (Affiliate Detector Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Scan article for affiliate opportunities. Identify: product/service mentions linkable to affiliate programs (Daraz, Amazon, financial products, SaaS tools). For each: suggest anchor text, placement paragraph, estimated commission value. Focus on Pakistani e-commerce.`;
