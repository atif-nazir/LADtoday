// ============================================================
// Agent 32 - Account Manager Agent
// Phase: DISTRIBUTE | Model: gemini-2.5-flash | Depends on: rewrite,excerpt
// ============================================================
// Routes 8 content formats to their correct publishing destinations
// ============================================================
...
const AGENT_NAME = "Account Manager Agent";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const prompt = `You are a specialized AI agent (Account Manager Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Create a publishing routing plan. Map each content type (article, thread, carousel, newsletter, WhatsApp, video, podcast, short-form) to its destination platform. Determine publishing priority, sequence, and any platform-specific formatting requirements.`;
