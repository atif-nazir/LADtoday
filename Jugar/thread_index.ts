// ============================================================
// Agent 27 - Thread Agent
// Phase: MULTIMEDIA | Model: gemini-2.5-flash | Depends on: rewrite,excerpt
// ============================================================
// Breaks articles into viral Twitter/X threads (8-12 tweets)
// ============================================================
...
const AGENT_KEY = "thread";
const AGENT_NAME = "Thread Agent";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const prompt = `You are a specialized AI agent (Thread Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Break this article into an 8-12 tweet Twitter/X thread. Tweet 1: Hook + thread emoji. Tweets 2-3: Context. Tweets 4-7: One key insight per tweet. Tweet 8: Turning point/controversy. Tweets 9-10: Resolution. Tweet 11: Best quote. Tweet 12: CTA with link. Each tweet MAX 280 chars.`;
