...
export function InfluencersTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      ) : <div className="text-sm text-muted-foreground text-center py-6">No influencers registered. Add above or let agent-40 discover them.</div>}

      <div className="flex items-center gap-3 mt-6"><span className="text-sm font-medium">Outreach Queue ({outreach.length})</span></div>
      {outreach.length > 0 ? (
