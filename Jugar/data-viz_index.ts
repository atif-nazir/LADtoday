// ============================================================
// Agent 31 - Data Viz Agent
// Phase: MULTIMEDIA | Model: gemini-2.5-flash | Depends on: intelligence,infographic
// ============================================================
// Generates embeddable HTML/CSS/JS data visualizations
// ============================================================
...
const AGENT_KEY = "data-viz";
const AGENT_NAME = "Data Viz Agent";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (runId) {
      for (const dep of ["intelligence","infographic"]) {
    ...
    const prompt = `You are a specialized AI agent (Data Viz Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Generate an embeddable Chart.js data visualization. Select best chart type for the data (line/bar/donut/table). Output self-contained HTML with all JS inline, responsive design, aria labels, branded colors. Include chart caption and source attribution.`;
