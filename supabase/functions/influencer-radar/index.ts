// ============================================================
// Agent 38 - Influencer Radar Agent
// Phase: DISTRIBUTE | Model: gemini-2.5-flash | Depends on: trend-forecaster,competitor-intel
// ============================================================
// Identifies relevant influencers for content amplification
// ============================================================
...
const AGENT_KEY = "influencer-radar";
const AGENT_NAME = "Influencer Radar Agent";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (runId) {
      for (const dep of ["trend-forecaster","competitor-intel"]) {
    ...
    const prompt = `You are a specialized AI agent (Influencer Radar Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Identify 5-10 relevant Pakistani influencers/thought leaders for this topic. Categorize: macro (>100K), micro (10K-100K), nano (<10K). For each: estimated reach, relevance score 1-10, platforms, best engagement approach. Generate outreach strategy.`;
