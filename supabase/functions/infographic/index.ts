// ============================================================
// Agent 23 - Infographic Agent
// Phase: MULTIMEDIA | Model: gemini-2.5-flash | Depends on: rewrite
// ============================================================
// Identifies data in articles and produces infographic specs + inline HTML charts
// ============================================================
...
const AGENT_KEY = "infographic";
const AGENT_NAME = "Infographic Agent";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const prompt = `You are a specialized AI agent (Infographic Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Analyze this article and identify the most infographic-worthy data set. Determine type (comparative, sequential, statistical, categorical). Generate: infographic spec with data_points, visual layout description, 3-color palette, and inline HTML/CSS chart code for article embed.`;
