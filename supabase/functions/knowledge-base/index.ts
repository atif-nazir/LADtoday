// ============================================================
// Agent 50 - Knowledge Base Agent
// Phase: OPERATE | Model: gemini-2.5-flash | Depends on: publish
// ============================================================
// Indexes published articles for cross-article context
// ============================================================
...
const AGENT_KEY = "knowledge-base";
const AGENT_NAME = "Knowledge Base Agent";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const prompt = `You are a specialized AI agent (Knowledge Base Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Extract key knowledge for the knowledge base. Generate: entity list (people, orgs, locations, with type tags), topic classification tags, fact database entries (claim + source + confidence), expertise domains covered, and suggested cross-references to related article topics.`;
