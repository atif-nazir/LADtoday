// ============================================================
// Agent 40 - Syndication Agent
// Phase: DISTRIBUTE | Model: gemini-2.5-flash | Depends on: publish
// ============================================================
// Manages content syndication to partner sites and aggregators
// ============================================================
...
const AGENT_KEY = "syndication";
const AGENT_NAME = "Syndication Agent";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const prompt = `You are a specialized AI agent (Syndication Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Create syndication plan: RSS-optimized excerpt (300 chars), partner site adaptation (shorter with canonical link), Google News metadata, content licensing terms, cross-posting schedule, and syndication target list for Pakistani media landscape.`;
