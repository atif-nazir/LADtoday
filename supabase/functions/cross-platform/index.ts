// ============================================================
// Agent 36 - Cross-Platform Adapter Agent
// Phase: DISTRIBUTE | Model: gemini-2.5-flash | Depends on: rewrite,excerpt
// ============================================================
// Generates platform-native content variants
// ============================================================
...
const AGENT_KEY = "cross-platform";
const AGENT_NAME = "Cross-Platform Adapter Agent";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (runId) {
      for (const dep of ["rewrite","excerpt"]) {
    ...
    const prompt = `You are a specialized AI agent (Cross-Platform Adapter Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Adapt article intro for each platform culture. Facebook: conversational, emotionally relatable, Pakistani references, question CTA. LinkedIn: professional insight, business value, 3 bullet takeaways. Instagram: visual-first, curiosity-led, emoji. Twitter: bold, direct, punchy.`;
