// ============================================================
// Agent 43 - Lead Magnet Agent
// Phase: MONETIZE | Model: gemini-2.5-flash | Depends on: rewrite,excerpt
// ============================================================
// Creates lead magnet ideas and email capture content
// ============================================================
...
const AGENT_KEY = "lead-magnet";
const AGENT_NAME = "Lead Magnet Agent";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const prompt = `You are a specialized AI agent (Lead Magnet Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Generate lead magnet ideas: 1) PDF checklist/guide outline, 2) 5-day email course outline, 3) Tool/calculator concept. Create opt-in copy (headline + 3 bullet benefits + CTA button text). Create exit-intent popup copy. All tailored for Pakistani audience.`;
