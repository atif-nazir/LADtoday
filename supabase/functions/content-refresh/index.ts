// ============================================================
// Agent 48 - Content Refresh Agent
// Phase: OPERATE | Model: gemini-2.5-flash | Depends on: analytics
// ============================================================
// Scans aging articles and recommends updates
// ============================================================
...
const AGENT_KEY = "content-refresh";
const AGENT_NAME = "Content Refresh Agent";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const prompt = `You are a specialized AI agent (Content Refresh Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Analyze article freshness: publication date, data recency, outdated statistics, new developments on topic, broken references. Score staleness 0-10. Recommend: update priority (high/medium/low), specific sections to refresh, new data to add, SEO improvements, re-promotion strategy.`;
