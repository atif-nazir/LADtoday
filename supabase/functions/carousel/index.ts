// ============================================================
// Agent 28 - Carousel Agent
// Phase: MULTIMEDIA | Model: gemini-2.5-flash | Depends on: rewrite,creative
// ============================================================
// Produces LinkedIn/Instagram carousel slide specs (6-10 slides)
// ============================================================
...
const AGENT_KEY = "carousel";
const AGENT_NAME = "Carousel Agent";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const prompt = `You are a specialized AI agent (Carousel Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Create 6-10 slide carousel spec. Slide 1: Cover headline. Slide 2: Problem. Slides 3-7: One insight per slide (title 5 words max, body 20-30 words, data point). Slide 8: Twist. Slide 9: Takeaway. Slide 10: CTA. Include image_prompt and colors per slide. Output for Instagram (1080x1080) + LinkedIn (1200x628).`;
