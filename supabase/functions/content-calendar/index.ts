// ============================================================
// Agent 44 - Content Calendar Agent
// Phase: MONETIZE | Model: gemini-2.5-flash | Depends on: trend-forecaster,competitor-intel,audience-listener
// ============================================================
// Plans 7-day content calendar based on trends and audience
// ============================================================
...
const AGENT_KEY = "content-calendar";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (runId) {
      for (const dep of ["trend-forecaster","competitor-intel","audience-listener"]) {
    ...
    const prompt = `You are a specialized AI agent (Content Calendar Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Create a 7-day content calendar for a Pakistani news/media site. Each day: topic suggestion (based on trends), content type (article/video/thread/carousel), target platform, optimal publish time PKT, estimated engagement level, competitor gap it fills.`;
