// ============================================================
// Agent 24 - Podcast Script Agent
// Phase: MULTIMEDIA | Model: gemini-2.5-flash | Depends on: rewrite
// ============================================================
// Converts articles into ready-to-record podcast scripts
// ============================================================
...
const AGENT_KEY = "podcast-script";
const AGENT_NAME = "Podcast Script Agent";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const prompt = `You are a specialized AI agent (Podcast Script Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Convert this article into a podcast script: cold open (15s hook), intro (30s), context segment (90s), main content adapted for ears (5-8 min) with verbal transitions, quote segments, [AD BREAK MARKER], conclusion (60s), outro. Add [PAUSE], [EMPHASIZE], [SLOWER] stage directions. Estimate total runtime.`;
