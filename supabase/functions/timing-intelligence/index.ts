// ============================================================
// Agent 34 - Timing Intelligence Agent
// Phase: DISTRIBUTE | Model: gemini-2.5-flash | Depends on: audience-listener,account-manager
// ============================================================
// Recommends optimal publish windows per platform for Pakistan audience
// ============================================================
...
const AGENT_KEY = "timing-intelligence";
const AGENT_NAME = "Timing Intelligence Agent";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (runId) {
      for (const dep of ["audience-listener","account-manager"]) {
    ...
    const prompt = `You are a specialized AI agent (Timing Intelligence Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Analyze optimal publish timing for Pakistani audience. Facebook: 8-10 AM or 8-11 PM PKT. LinkedIn: Tue-Thu 9 AM-12 PM. Twitter: 9-11 AM or 5-7 PM. Email: Tue-Thu 9-10 AM. WhatsApp: 7-9 PM. For BREAKING news: publish immediately. Generate scheduling_plan with delay_minutes per platform.`;
