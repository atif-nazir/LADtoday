// ============================================================
// Agent 26 - Short Form Agent
// Phase: MULTIMEDIA | Model: gemini-2.5-flash | Depends on: headline-optimizer,excerpt
// ============================================================
// Creates TikTok/Reels/Shorts scripts (30-60s)
// ============================================================
...
const AGENT_KEY = "short-form";
const AGENT_NAME = "Short Form Agent";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (runId) {
      for (const dep of ["headline-optimizer","excerpt"]) {
    ...
    const prompt = `You are a specialized AI agent (Short Form Agent) for Pakistani digital media platform LADtoday.
Topic: "${topic}"
...
Create 3 short-form script variants (90-120 words each): A) Reaction hook, B) Question hook, C) Countdown hook. For each include on-screen text suggestions, sound/music suggestion, and 5 hashtags. Select best variant based on trending format.`;
